...
//  In the instance it is run, I think the context it is based in is the main execution context. 
//  So it refernces the window object as the place it is happening. Though 'this' does not hold the information when console.loging the definition.  
